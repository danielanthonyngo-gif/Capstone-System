...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-brand"><i class="fas fa-cube me-2"></i>INSPIRO</div>
        <nav class="nav-menu">
            ...
            <a href="create_item.php" class="nav-item"><i class="fas fa-plus-circle"></i> Create Item</a>
            <a href="manage_user.php" class="nav-item active"><i class="fas fa-users-cog"></i> Manage Users</a>
        </nav>
    </aside>
